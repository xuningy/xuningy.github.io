/*
	Edited by Xuning Yang. Credits to @n33co for skel.js package.
*/
				...
				if (_settings.useParallax)
				{
					...
					$window
						.on('scroll.overflow_parallax', function() {
							...
							$bg_nav.css('background-position', 'center ' + (-1 * (parseInt($window.scrollTop()) / _settings.parallaxFactor)) + 'px');
